...
const VideoShowcaseSection = () => {
  return (
    <section id="video-showcase" className="relative w-full h-screen overflow-hidden">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center py-2 sm:py-0">
        ...
        <div className="relative max-w-6xl mx-auto flex-1 flex items-center w-full">
          <div className="relative w-full rounded-lg sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl shadow-purple-500/30 border border-purple-400/50 sm:border-2 sm:border-gradient-to-r sm:from-purple-400 sm:to-amber-400 p-0.5 sm:p-1">
            <div className="relative bg-black rounded-md sm:rounded-xl lg:rounded-2xl overflow-hidden aspect-video">
              ...
              <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 right-2 sm:right-4 flex justify-between items-center">
                ...
                <div className="text-white text-xs sm:text-sm bg-black/30 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full backdrop-blur-sm">
                  0:10
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-2 sm:mt-8">
          ...
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-purple-600 to-amber-500 hover:from-purple-500 hover:to-amber-400 text-white font-bold px-4 sm:px-8 py-3 sm:py-6 rounded-lg sm:rounded-2xl text-sm sm:text-lg transition-all duration-300 hover:scale-105 shadow-xl"
          >
